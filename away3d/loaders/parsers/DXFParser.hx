...
{
	private static inline var LIMIT:UInt = 65535;
	private static inline var SETLIMIT:UInt = 17872;
	private static var CR:String = String.fromCharCode(10);
	
	private static inline var FACE:String = "3DFACE";
	private static inline var LINE:String = "LINE";
	private static inline var VERTEX:String = "VERTEX";
	private static inline var POLYLINE:String = "POLYLINE";
	
	private var _textData:String;
	private var _startedParsing:Bool;
	private var _trim:EReg = ~/^[ \t]/g;
	...
	private var _meshesDic:Map<String, Mesh>;
	...
	override private function proceedParsing():Bool
	{
		...
		if (!_startedParsing) {
			...
			_meshesDic = new Map<String, Mesh>();
