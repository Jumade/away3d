...
class ShaderPicker implements IPicker
{
	...
	private function getPreciseDetails(camera:Camera3D):Void
	{
		...
		var v2x:Float, v2y:Float, v2z:Float;
		var dot00:Float, dot01:Float, dot02:Float, dot11:Float, dot12:Float;
		var s:Float, t:Float, invDenom:Float;
		var uvs:Vector<Float> = subGeom.UVData;
		var normals:Vector<Float> = subGeom.faceNormals;
		var x:Float = _localHitPosition.x, y:Float = _localHitPosition.y, z:Float = _localHitPosition.z;
		var u:Float, v:Float;
		var ui1:Int, ui2:Int, ui3:Int;
